...
def solve(dx=0.216, dy=0.216, D=1.6):
    # plate size, mm
    w = h = 10.
    ...
    for n in range(nsteps):
        ...
        if n in n_output:
            fig_counter += 1
            last_image = create_plot(fig, fig_counter, u, n * dt, T_cold, T_hot)

    # Plot output figures
    output_plots(fig, last_image)

if __name__ == "__main__":
    # So that I can still just run that file
    solve()